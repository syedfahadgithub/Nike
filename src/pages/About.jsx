      ...
      <div className='w-full h-screen'>
        <div className='flex'>
          <div className='p-7 '>
            ...
            <p className='text-sm mt-10 leading-none'>Nike exists to bring inspiration and innovation to every athlete in the world. And if you have a body — you're an athlete.
